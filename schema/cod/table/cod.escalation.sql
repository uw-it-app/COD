...
CREATE TRIGGER t_93_dash_on_insert AFTER INSERT ON escalation FOR EACH ROW EXECUTE PROCEDURE escalation_dash_update();


--
-- Name: t_93_dash_on_update; Type: TRIGGER; Schema: cod; Owner: postgres
--

CREATE TRIGGER t_93_dash_on_update AFTER UPDATE ON escalation FOR EACH ROW WHEN (((old.owner)::text <> (new.owner)::text)) EXECUTE PROCEDURE escalation_dash_update();


--
-- Name: t_95_notify_peers; Type: TRIGGER; Schema: cod; Owner: postgres
--

CREATE TRIGGER t_95_notify_peers AFTER INSERT ON escalation FOR EACH ROW EXECUTE PROCEDURE escalation_notify_peers();
